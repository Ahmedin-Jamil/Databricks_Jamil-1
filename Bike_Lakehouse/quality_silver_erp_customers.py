...
# DBTITLE 1,Silver Quality Check - ERP Customers
# MAGIC %md
# MAGIC # 🛡️ Silver Layer Quality Check - ERP Customers
# MAGIC
# MAGIC ## Validates:
# MAGIC * **Bronze:** `workspace_1.bronze.erp_cust_az12`
# MAGIC * **Silver:** `workspace_1.silver.erp_customers_id`
...
QUALITY_CONFIG = {
    ...
    "task_name": "Quality_Silver_ERP_Customers",
    "layer": "SILVER",
    "bronze_table": "workspace_1.bronze.erp_cust_az12",
    "silver_table": "workspace_1.silver.erp_customers_id",
    "monitoring_table": "workspace_1.monitoring.data_quality_log",
    "fail_on_critical": False
}
print("✅ Silver ERP Customers Quality Check Initialized")
...
# MAGIC %sql
# MAGIC SELECT
# MAGIC   (SELECT COUNT(*) FROM workspace_1.bronze.erp_cust_az12) as bronze_count,
# MAGIC   (SELECT COUNT(*) FROM workspace_1.silver.erp_customers_id) as silver_count,
# MAGIC   CASE WHEN (SELECT COUNT(*) FROM workspace_1.bronze.erp_cust_az12) = (SELECT COUNT(*) FROM workspace_1.silver.erp_customers_id) THEN '✅ PASS' ELSE '🟡 WARNING' END as status
