...
# DBTITLE 1,Silver Quality Check - ERP Products
# MAGIC %md
# MAGIC # 🛡️ Silver Layer Quality Check - ERP Products
# MAGIC
# MAGIC ## Validates:
# MAGIC * **Bronze:** `workspace_1.bronze.erp_px_cat_g1v2`
# MAGIC * **Silver:** `workspace_1.silver.erp_product_category`
...
QUALITY_CONFIG = {
    ...
    "task_name": "Quality_Silver_ERP_Products",
    "layer": "SILVER",
    "bronze_table": "workspace_1.bronze.erp_px_cat_g1v2",
    "silver_table": "workspace_1.silver.erp_product_category",
    "monitoring_table": "workspace_1.monitoring.data_quality_log",
    "fail_on_critical": False
}
print("✅ Silver ERP Products Quality Check Initialized")
...
# MAGIC %sql
# MAGIC SELECT
# MAGIC   (SELECT COUNT(*) FROM workspace_1.bronze.erp_px_cat_g1v2) as bronze_count,
# MAGIC   (SELECT COUNT(*) FROM workspace_1.silver.erp_product_category) as silver_count,
# MAGIC   CASE WHEN (SELECT COUNT(*) FROM workspace_1.bronze.erp_px_cat_g1v2) = (SELECT COUNT(*) FROM workspace_1.silver.erp_product_category) THEN '✅ PASS' ELSE '🟡 WARNING' END as status
